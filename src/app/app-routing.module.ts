...
@NgModule({
  imports: [RouterModule.forRoot(routes), HomeComponentModule, EmployeeListComponentModule, EmployeeServiceModule, EmployeeFormComponentModule, EmployeeDetailsComponentModule],
